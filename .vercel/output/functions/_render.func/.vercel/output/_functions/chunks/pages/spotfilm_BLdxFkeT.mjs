...
const html = "<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>";
				...
				const frontmatter = {"title":"Under Construction","url":"http://localhost","tags":["react","javaScript","axios","HTML","SCSS","CSS"],"date":2025};
				const file = "C:/Users/rfrodrigues/Downloads/resume/src/pages/projects/spotfilm.md";
				const url = "/resume/projects/spotfilm";
				function rawContent() {
